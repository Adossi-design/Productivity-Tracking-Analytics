...
class DashboardScreen extends StatelessWidget {
  ...
  Widget _buildRecentProjects(
    ...
    for (final entry in repo.entries) {
      projectHours[entry.projectName] =
          (projectHours[entry.projectName] ?? 0) + entry.totalTime;
    }
  ...
  Widget _buildMLInsightsPreview(
    BuildContext context,
    ProductivityRepository repo,
  ) {
    final l = AppLocalizations.of(context)!;
    ...
    if (repo.entries.length < 5) {
      return _EmptySection(
        ...
        subtitle:
            '${l.logMoreSessions} ${5 - repo.entries.length} ${l.sessionsToUnlock}',
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Tap to explore detailed insights',
