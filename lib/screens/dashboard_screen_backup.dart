    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text('📁 ${l.topProjects}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
            TextButton(
              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ProjectManagementScreen())),
            ...
            children: topProjects.asMap().entries.map((entry) {
              ...
              return Column(
                children: [
                  ...
                  if (!isLast) Divider(height: 1, indent: 88, color: Colors.grey[200]),
                ],
              );
            }).toList(),
          ),
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('📝 ${l.recentActivity}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
            TextButton(
              ...
              return Column(
                children: [
                  ListTile(
                    ...
                    title: Text(item.taskName, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 15)),
                    subtitle: Text(
